...
INSTANTIATE_TEST_CASE_P(LawlerNetworkStructure,
                        ...
                        ::testing::Values(std::make_pair(2, std::set<edge>({EDGE(10,INFTY)})),
                                          std::make_pair(4, std::set<edge>({EDGE(10,INFTY),EDGE(11,INFTY)})),
                                          std::make_pair(5, std::set<edge>({EDGE(11,INFTY),EDGE(12,INFTY),EDGE(13,INFTY),EDGE(14,INFTY)})),
                                          std::make_pair(10, std::set<edge>({EDGE(17,1)})),
                                          std::make_pair(17, std::set<edge>({EDGE(2,INFTY),EDGE(3,INFTY),EDGE(4,INFTY)})),
                                          std::make_pair(14, std::set<edge>({EDGE(21,1)})),
                                          std::make_pair(21, std::set<edge>({EDGE(5,INFTY),EDGE(6,INFTY),EDGE(7,INFTY)})) ));
...
INSTANTIATE_TEST_CASE_P(NodeDegreeNetworkStructure,
                        ...
                        ::testing::Values(std::make_pair(10, std::set<edge>({EDGE(17,1)})),
                                          ...
                                          std::make_pair(5, std::set<edge>({EDGE(11,INFTY),EDGE(12,INFTY),EDGE(13,INFTY),EDGE(14,INFTY)})),
                                          std::make_pair(21, std::set<edge>({EDGE(5,INFTY),EDGE(12,INFTY),EDGE(13,INFTY),EDGE(15,INFTY),EDGE(16,INFTY)})),
                                          std::make_pair(22, std::set<edge>({EDGE(12,INFTY),EDGE(14,INFTY)})) ));
...
INSTANTIATE_TEST_CASE_P(EdgeSizeNetworkStructure,
                        WongNetworkTest,
                        ::testing::Values(std::make_pair(4, std::set<edge>({EDGE(5,1),EDGE(10,INFTY)})),
                                          std::make_pair(5, std::set<edge>({EDGE(4,1),EDGE(6,1),EDGE(7,1),EDGE(14,INFTY)})),
