...
class NoDataBinaryMinHeap {
 ...
 public:
  ...
  NoDataBinaryMinHeap(const NoDataBinaryMinHeap&) = delete;
  NoDataBinaryMinHeap& operator= (const NoDataBinaryMinHeap&) = delete;

  NoDataBinaryMinHeap(NoDataBinaryMinHeap&&) = default;
  NoDataBinaryMinHeap& operator= (NoDataBinaryMinHeap&&) = default;
