...
private:
	...
	void recursiveBisection(Hypergraph& hyper, PartitionID k1, PartitionID k2) {
		...
		InitialPartitionerBase::extractPartitionAsHypergraph(hyper, 0, num_hypernodes_0,
		...
		Hypergraph partition_0(num_hypernodes_0, num_hyperedges_0, index_vector_0,
				edge_vector_0, _config.initial_partitioning.k);
		...
		InitialPartitionerBase::extractPartitionAsHypergraph(hyper, 1, num_hypernodes_1,
		...
		Hypergraph partition_1(num_hypernodes_1, num_hyperedges_1, index_vector_1,
				edge_vector_1, _config.initial_partitioning.k);
