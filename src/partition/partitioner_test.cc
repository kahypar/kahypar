...
TEST_F(APartitioner, CalculatesPinCountsOfAHyperedgesAfterInitialPartitioning) {
  ASSERT_THAT(hypergraph->pinCountInPartition(0, Hypergraph::kInvalidPartition), Eq(2));
  ...
  partitioner.partition(*hypergraph, *coarsener, *refiner);
  ASSERT_THAT(hypergraph->pinCountInPartition(0, Hypergraph::kInvalidPartition), Eq(0));
  ASSERT_THAT(hypergraph->pinCountInPartition(0, 0), Eq(0));
  ASSERT_THAT(hypergraph->pinCountInPartition(0, 1), Eq(2));
  ASSERT_THAT(hypergraph->pinCountInPartition(2, Hypergraph::kInvalidPartition), Eq(0));
