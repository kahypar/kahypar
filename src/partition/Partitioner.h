...
void Partitioner::performDirectKwayPartitioning(Hypergraph& hypergraph, const Configuration& config) {
  ...
  performDirectKwayPartitioning(hypergraph, *coarsener, *refiner, config);
}
